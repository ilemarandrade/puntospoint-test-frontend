...
const CardPulso: React.FC<IProps> = ({ data, className }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between" data-testid="card-pulso-client">
        <p className="text-sm">Clientes</p>
        <p className="text-sm">{formatNumber(clients)}</p>
      </div>
      <div className="flex justify-between" data-testid="card-pulso-sale">
        <p className="text-sm">Ventas Totales</p>
        <p className="text-sm">{formatNumber(totalSales)}</p>
      </div>
      <div className="flex justify-between" data-testid="card-pulso-amount">
      ...
      <div
        ...
        data-testid="card-pulso-accumulated"
      >
      ...
      {invoiced?.length &&
        invoiced.map((invoice, index) => (
          <div
            className="flex justify-between"
            key={`invoice-${index}`}
            data-testid="card-pulso-invoice"
          >
